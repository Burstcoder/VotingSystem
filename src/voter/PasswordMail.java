...
import javax.mail.internet.MimeMessage;
	public class PasswordMail {
		...
		public boolean sendMail(String to,String otp) throws MessagingException 
		{
			...
			String username="rahulxda99587@gmail.com";//emailid 
			String password="rahul@its";//emailid password
			String from="rahulxda99587@gmail.com";// email from which u have to send
